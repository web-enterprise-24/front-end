...
const Dashboard = () => {
 return (
  <>
   ...
   <div className="flex flex-row justify-between w-full h-full bg-base-300">
    <SidebarFixed items={SidebarDashboardItems} />
    <div className="w-full h-full ml-1 mt-1 shadow-md shadow-base-100 bg-base-100 rounded-2xl">
     <Outlet />
    </div>
   </div>
  </>

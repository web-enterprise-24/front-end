...
const AddNew = () => {
	...
	return (
		<div className='w-full flex flex-col items-center justify-center gap-8 mt-4'>
			<div
				role='tablist'
				className='tabs tabs-boxed font-bold'
			>
				<a
					role='tab'
					className={`tab ${tabActive === 1 && 'bg-secondary text-base-100'}`}
					onClick={() => {
						setTabActive(1);
					}}
				>
				...
				<a
					role='tab'
					className={`tab ${tabActive === 2 && 'bg-secondary text-base-100'}`}
					onClick={() => {
						setTabActive(2);
					}}
				>
				...
				<a
					role='tab'
					className={`tab ${tabActive === 3 && 'bg-secondary text-base-100'}`}
					onClick={() => {
						setTabActive(3);
					}}
				>
